...
class StarterSite extends Timber\Site {
    ...
    public function register_assets(){
        ...
        wp_enqueue_script('my-js',get_template_directory_uri() . '/assets/js/main.js', array(), '', true);
        ...
        wp_enqueue_style('my-styles', get_template_directory_uri() . '/assets/css/main.css', array(), 1.0);
